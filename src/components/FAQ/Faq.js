  ...
  return (
    <div className={styles.Faq}>
      ...
      <p className={styles.Answers}>
        ...
        illness. People with fever, cough and difficulty breathing should seek
        medical attention.
      </p>
      </div>
      <div className={styles.QuestionsDiv1}>
      ...
      <p className={styles.Answers}>
        ...
        can spread from person to person through small droplets from the nose or
      ...
      <div className={styles.QuestionsDiv2}>
      <p className={styles.Questions}>What can I do to protect myself and prevent the spread of disease?</p>
      ...
      <p className={styles.Answers}>
        ...
        on the national,state and local public health authority. Many countries
        around the world have seen cases of COVID-19 and several have seen
        outbreaks. Authorities in China and some other countries have succeeded
      ...
      <ul>
        ...
        <li>
          ...
          droplets, including the COVID-19 virus if the person coughing has the
          disease.
        </li>
        <li>
        ...
        <li>
          ...
          or lung disease. Why? You have a higher chance of catching COVID-19 in
          one of these areas.
        </li>
      </ul>
      </div>
      <div className={styles.QuestionsDiv1}>
      <p className={styles.Questions}>Who is at risk of developing severe illness?</p>
      <p className={styles.Answers}>
        ...
        blood pressure, heart disease, lung disease, cancer or diabetes) appear
        to develop serious illness more often than others.{" "}
      </p>
      </div>
      <div className={styles.QuestionsDiv2}>
      <p className={styles.Questions}>Should I wear mask to protect myself?</p>
      <p className={styles.Answers}>
        ...
        yourself and others against COVID-19 are to frequently clean your hands,
        cover your cough with the bend of elbow or tissue and maintain a
